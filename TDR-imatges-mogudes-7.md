...
_Construcció d’altaveus personalitzats vs. Altaveues comercials_

Índex

[Resum 3](#_Toc241161919)

[Introducció 3](#_Toc241161920)

[Motivació del projecte: 3](#_Toc241161921)

[Hipòtesis: 3](#_Toc241161922)

[Objectius: 3](#_Toc241161923)

[Marc teòric: 4](#_Toc241161924)

[El so: 4](#_Toc241161925)

[Característiques del so 4](#_Toc241161926)

[Els altaveus i el seu funcionament: 7](#_Toc241161927)

[El driver (peça): 7](#_Toc241161928)

[El senyal: 15](#_Toc241161929)

[Crossover: 16](#_Toc241161930)

[Capsa: 18](#_Toc241161931)

[Directivitat i dispersió: 20](#_Toc241161932)

[Amplificador: 21](#_Toc241161933)

[L’estèreo, la imatge sonora i l’acústica de la sala: 24](#_Toc241161934)

[Mesura i identificació de mesura 25](#_Toc241161935)

[Marc pràctic: 27](#_Toc241161936)

[Introducció: 27](#_Toc241161937)

[Disseny de l’altaveu: 27](#_Toc241161938)

[Construcció dels altaveus: 31](#_Toc241161939)

[Resultats i comparació: 34](#_Toc241161940)

[Preu final: 34](#_Toc241161941)

[Introducció de productes: 35](#_Toc241161942)

[Comparació de rendiment: 37](#_Toc241161943)

[Comparació de preu: 40](#_Toc241161944)

[Conclusió: 41](#_Toc241161945)

[Bibliografia 42](#_Toc241161946)
...
The project analyses the main theoretical aspects involved in loudspeaker design, including sound propagation, frequency response, directivity, distortion, driver technologies, crossover systems, Thiele-Small parameters, enclosure design and amplification. Based on these principles, a three-way loudspeaker was designed using a woofer, a midrange driver and a tweeter, with digital crossover points at 600 Hz and 2.5 kHz. The system incorporates a bass-reflex enclosure and digital signal processing for crossover filtering, equalisation, delay and level adjustment.
...
És possible construir, amb coneixements autodidactes i un pressupost limitat, un altaveu d’alta fidelitat amb un rendiment comparable al d’opcions comercials de gamma mitjana-alta.
...
El so és una ona, és a dir, una pertorbació o variació que viatja a través d’un medi. Per exemple, explicat per Dan Russell (https://www.acs.psu.edu/drussell/Demos/waves-intro/waves-intro.html), una ona és com la gent d’un partit formant una “ona”. Un grup de gent s’aixeca i s’asseu, el grup del costat repeteix la mateixa acció, generant així una ona que es propaga per tot l’estadi. Tenim una variació, la gent aixecant-se, que es va desplaçant per tot l’estadi. Els individus no es mouen, però l’onada és transportada per tot l’estadi.
...
La fase indica en quin punt del seu cicle es troba una ona respecte d'un punt de referència. Es pot expressar en graus, on un cicle complet correspon a 360°. Dues ones de la mateixa freqüència poden estar en fase quan els seus cicles coincideixen, o desfasades quan una està avançada o retardada respecte de l'altra.
...
#### El rang de freqüències audible
...
#### La resposta en freqüència

La resposta en freqüència descriu com varia el nivell de reproducció d'un altaveu segons la freqüència. Es pot representar mitjançant un gràfic on l'eix horitzontal correspon a la freqüència i el vertical al nivell de pressió sonora. Una resposta idealment plana indicaria que totes les freqüències es reprodueixen al mateix nivell, tot i que en un sistema real sempre hi ha determinades variacions.
...
Finalment, els tweeters són els encarregats de reproduir les freqüències altes. Com que aquestes freqüències tenen longituds d’ona molt petites, es necessiten elements mòbils de baixa massa capaços de reproduir aquestes variacions ràpides. Per això, els tweeters acostumen a ser petits i fabricats amb materials molt lleugers. Existeixen diferents dissenys com el dome tweeter, el ribbon tweeter (semblant al planar que veurem a continuació) i els altaveus de “_banya_”, que s’assemblen a una trompeta.
...
#### Driver electrodinàmic (Il·lustració 1):
...
Aquesta membrana es col·loca entre dos conjunts d’imants. Quan el corrent elèctric passa pel conductor, es genera una força a causa de la interacció entre el camp magnètic produït pel corrent i el dels imants, provocant el moviment de la membrana.
...
S’utilitza principalment en auriculars, tot i que també existeixen altaveus planar-magnetic.
...
En els sistemes d'àudio digitals, una part del processament del senyal es pot realitzar abans de convertir-lo al domini analògic. El processament digital de senyal (DSP, de l'anglès Digital Signal Processing) consisteix en l'aplicació d'operacions matemàtiques sobre un senyal digital per modificar-ne o controlar-ne determinades característiques. En el cas dels sistemes d'àudio, això permet realitzar funcions com el filtratge de freqüències, l'equalització, l'ajust del nivell, la modificació del retard o altres correccions del senyal sense necessitat de modificar físicament el circuit.

Aquesta capacitat resulta especialment útil en sistemes de diversos drivers, ja que permet controlar de manera independent les diferents vies i adaptar el comportament del conjunt. A diferència d'un crossover passiu, on les característiques del filtratge depenen dels components electrònics utilitzats, el processament digital permet modificar amb precisió els paràmetres del filtre i combinar diferents funcions de processament dins del mateix sistema. Per aquest motiu, el DSP és una eina habitual en sistemes d'àudio actius on es busca un major control sobre la resposta del conjunt.
...
El tipus de capsa influeix molt en el resultat final. Les capses tancades ofereixen un comportament més controlat, mentre que les bass-reflex utilitzen un port (una obertura) per reforçar els greus i augmentar l’eficiència (il·lustració 7). Aquesta obertura pot estar integrada directament dins de la capsa o adoptar la forma d’un tub. La seva mida i longitud determinen la freqüència a la qual està sintonitzada la capsa, permetent aprofitar el moviment de l’aire del seu interior per reforçar les freqüències baixes.
...
## L’estèreo, la imatge sonora i l’acústica de la sala:
...
Per reduir l’efecte d’aquests problemes, s’utilitzen materials absorbents (com escuma acústica, catifes, cortines gruixudes o panells de llana mineral) que absorbeixen l’energia sonora de les reflexions, i difusors, que dispersen el so de manera més uniforme en comptes de reflectir-lo cap a un sol punt. En sales professionals d’enregistrament o de monitoratge, el tractament acústic és tan important com els mateixos altaveus. En un entorn domèstic, tot i que no cal arribar a l’extrem d’un estudi professional, una bona col·locació dels altaveus i alguns elements absorbents estratègics poden marcar una diferència notable en la qualitat del so.

## Mesura i identificació de mesura
...
#### Limitacions de les mesures acústiques
...
- _Sistema actiu i integrat_

Electrònica i amplificació integrades en una sola unitat autònoma (plug-and-play), evitant l'ús d'amplificadors o caixes externes per a la màxima simplicitat d'ús.

- _Connectivitat sense fils_

Ha de comptar amb protocols de transmissió sense fils per Wi-Fi (com AirPlay 2, Chromecast o Spotify Connect) i Bluetooth, facilitant l'enviament d'àudio directament des de qualsevol dispositiu sense la necessitat de cables.

- _Visualment agradable_

## Disseny de l’altaveu:

#### Arquitectura del sistema:

Després d’investigar i provar diferents opcions, es va decidir construir un **altaveu actiu de tres vies amb una caixa bass-reflex, crossover digital, processament digital de senyal i amplificació integrada**. Aquesta configuració permet repartir l’espectre audible entre els tres drivers i fer que cadascun treballi principalment dins del rang de freqüències per al qual ha estat seleccionat.

A diferència d’un altaveu passiu convencional, en aquest cas el processament del senyal i l’amplificació es realitzen dins del mateix altaveu. D’aquesta manera, no és necessari utilitzar un amplificador extern ni un crossover passiu entre l’amplificador i els drivers. Cada via disposa del seu propi canal d’amplificació després del processament digital, cosa que permet controlar de manera independent el woofer, el mid-woofer i el tweeter.

El senyal d’àudio és rebut per una unitat de computació mitjançant una connexió sense fils i es manté en format digital fins arribar al convertidor digital-analògic (DAC). Un cop convertit, el senyal és processat pel DSP, on es realitza la separació de les tres vies i els diferents ajustos necessaris. Posteriorment, cada via és amplificada de manera independent i enviada al driver corresponent.

La resta de l’electrònica i l’alimentació també queden integrades dins de la caixa, fent que el sistema funcioni com una unitat independent i que només sigui necessari connectar-lo a l’alimentació.

#### Components electrònics:

Per implementar l’arquitectura definida es van seleccionar diferents components electrònics que treballen conjuntament. Inicialment es va plantejar utilitzar un ESP32-S3 com a unitat de computació. Un ESP32 és, essencialment, un petit ordinador sense pantalla ni perifèrics, pensat per controlar dispositius i comunicar-se amb altres sistemes. En aquest cas, s’havia de fer servir per gestionar la recepció d’àudio sense fils. Després de diverses proves amb diferents plaques no es va aconseguir obtenir un funcionament estable, de manera que es va optar finalment per una Raspberry Pi Zero 2 W. Aquesta, a més de solucionar els problemes inicials, ofereix una major compatibilitat amb diferents sistemes i aplicacions d’àudio. Tot i tenir un preu una mica més elevat, es va considerar una opció més flexible per al projecte. Per al segon altaveu es va utilitzar una consola d’emulació portàtil reutilitzada que, a efectes del projecte, pot complir essencialment la mateixa funció que la Raspberry Pi com a unitat de computació. D’aquesta manera, es va evitar haver d’adquirir una segona Raspberry Pi, ja que el dispositiu disponible permetia realitzar la mateixa funció dins del sistema. Tot i això, per al càlcul del cost del projecte es considera el preu d’una segona Raspberry Pi Zero 2 W, ja que és la solució prevista per a una implementació equivalent dels dos altaveus.

Per al processament i l’amplificació del senyal es va seleccionar el mòdul Wondom JAB4, principalment per tres motius. En primer lloc, integra un DSP, necessari per implementar el crossover digital i realitzar els diferents ajustos del senyal. En segon lloc, disposa de quatre canals d’amplificació, dels quals se’n necessiten tres per alimentar independentment el woofer, el mid-woofer i el tweeter. Finalment, el JAB4 integra aquestes funcions en un únic mòdul i a un cost relativament reduït, fet que el va convertir en una opció adequada per a les necessitats del projecte.

Il·lustració 11 - "Baffle"

#### Disposició frontal

La disposició dels drivers a la part frontal, el “baffle” de la caixa està condicionada principalment per les interferències entre ells i per la directivitat del conjunt. En un sistema de tres vies, la separació entre els centres acústics dels drivers pot provocar lòbuls i cancel·lacions, especialment fora de l’eix principal. Per aquest motiu, les possibilitats de disposició no són tan àmplies com podria semblar inicialment.

En aquest projecte, es va arribar inicialment a una disposició horitzontal dels tres drivers, ja que permet mantenir una distància vertical reduïda entre els centres acústics i, per tant, controlar millor les interferències en el pla vertical. Aquesta configuració coincideix amb la utilitzada en monitors com l’[ATC SCM25A Pro Mk2](https://atc.audio/en/professional/loudspeakers/scm25a-pro-mk2/), un model que també es va prendre com a referència durant el desenvolupament del projecte.

Posteriorment, es va considerar més adequada una disposició vertical, ja que permet situar els drivers sobre el mateix eix vertical i desplaçar les principals interferències cap al pla vertical, on tenen un impacte menor per a un oient que es troba a una alçada similar a la de l’altaveu. El resultat va donar lloc a una configuració molt similar a la utilitzada en el [JBL L100 Mk2](https://www.jbl.es/L100-MK2.html), tot i que aquesta disposició es va obtenir a partir dels criteris acústics del propi disseny i no a partir de la reproducció d’una configuració existent.

Finalment, els tres drivers es van disposar verticalment però lleugerament desalineats entre ells, amb el bass port situat al costat del mid-woofer (Il·lustració X). Aquesta configuració permet mantenir les dimensions del frontal dins dels límits establerts pel disseny de la caixa, alhora que es manté el control de les interferències entre els diferents drivers.

#### Selecció de drivers:

La selecció dels drivers per a un sistema de 3 vies s'ha de realitzar pensant en com s'enllacen els seus rangs de freqüència per poder fer les transicions entre drivers sense deixar “buits”. Altres paràmetres com la sensibilitat o la impedància no són tan rellevants degut a l’ús d’un crossover digital:

- HiVi Swan M6N 6”, 8 Ω

S'ha seleccionat com a woofer principal per la seva bona relació qualitat-preu i pel fet d'estar dissenyat específicament per a rendir en un recinte ventilat amb ‘bass port’. A més, s'ha escollit pel seu acabat de color coure (fet d'un aliatge de magnesi i alumini).
...
Per aquest motiu, s'ha optat per un disseny digital, que permet fer ajustos amb programari sense requerir modificació dels components ja instal·lats. Això ofereix una gran flexibilitat pel que fa al so final, permetent, per exemple, l'equalització a partir de l'habitació o la correcció del desfasament detectat en un dels altaveus. A més, això suposa un estalvi econòmic important durant la fase de "prototipatge", ja que permet provar diferents ajustos sense haver de comprar nous components cada vegada.

Il·lustració 12 - "SigmaStudio", el programari per a configurar el crossover digital

driver

8

En productes comercials, es pot preferir un crossover passiu per la seva simplicitat, cost de producció i relativa facilitat de reparació.  
...
Els punts de tall entre vies (entre cada driver) s'han establert a 600 Hz (entre el “woofer” i el “mid-woofer”) i 2.500 Hz (entre el “mid-woofer” i el “tweeter”) per prioritzar la resposta fora d’eix. Per implementar-los, s'ha utilitzat un filtre Linkwitz-Riley de vuitè ordre (LR8), amb un pendent de 48 dB/oct, un tipus de filtre en què els dos drivers adjacents tanquen exactament a la mateixa freqüència, fent que, en sumar-se les seves respostes, el resultat sigui pla i sense pics ni caigudes al punt de tall. Tot i que la diferència audible és petita, un pendent més pronunciat redueix encara més la superposició entre drivers adjacents. A més, en tractar-se d'un crossover digital, optar per un pendent més agressiu no comporta cap component addicional ni complexitat extra, a diferència del crossover passiu.

Il·lustració 13 – “Baffle” de dues planxes d’MDF

#### **_Disseny_** de la capsa:

La capsa té un volum intern de 12,8 L, lleugerament per sota de l'objectiu inicial de 14 L (veure “Construcció dels altaveus”). Les dimensions externes són d'aproximadament 40x20x21 cm, amb un “baffle” (part frontal del altaveu) de MDF de 2 cm de gruix (ajuntant dos panells de 1cm, il·lustració 13) i la resta de panells en contraxapat d'1 cm. El mid-woofer i el tweeter estan allotjats en un subcompartiment aïllat amb forma de "L" (il·lustració 14). Aquesta forma permet aïllar els dos drivers sense afectar el “bass port” ni sacrificar un volum excessiu de la capsa, ja que cap d'aquests dos drivers necessita tant d'espai com el woofer.
...
Per reduir vibracions i ressonàncies no desitjades, s'ha afegit un reforç estructural ("bracing", il·lustració 15) de dalt a baix i de dreta a esquerra, fet amb una barra de contraxapat d'uns 2 cm d'amplada i 1 cm de gruix. Aquest reforç és purament estructural, sense dividir l'interior de la capsa en compartiments separats. També, s'ha afegit farciment de polièster acústic per esmorteir l'interior de la capsa.

Il·lustració 15 – “Bracing”

## Construcció dels altaveus:
...
| Electrònica (PSU, DAC...) | 79,79 € |
| Amplificador | 107 € |
| Materials (Fusta, pintura, cola) | 55 € |
| **TOTAL** | 413,79 € |
...
|     |     |     |     |
| --- | --- | --- | --- |
|     | Disseny propi | Wharfedale Linton Heritage | Genelec 8341A |
| Resposta en frequència | 40Hz–20kHz (±3dB) | 40Hz–20kHz (±3dB) | 45Hz–20kHz (±1,5dB) |
| THD\* (Distorsió harmònica total) | ~1–3% entre 100Hz–10kHz a ~77dB SPL | n/a | <2% entre 50-100Hz i <0,5% per sobre de 100Hz, a 90dB SPL |
| Sensibilitat | Actiu, no aplicable | 90dB | Actiu, no aplicable |
| SPL màxim\* (volum) | 97dB (curt termini) | 110dB (curt termini) | 110dB (curt termini) |
| Punts de crossover | 600Hz / 2.500Hz, actiu | 630Hz / 2.400Hz, passiu | 500Hz / 3.000Hz, actiu |
| Preu (parell) | ~414€ | ~1.100–1.500€ | ~4.500–4.620€ |
...
#### Dependència de la configuració del crossover digital:

A diferència del Genelec 8341A, que ve calibrat de fàbrica i disposa d'eines de calibratge automàtic (GLM), el rendiment del disseny propi depèn directament de qui configura el crossover. Un exemple concret és la inversió de fase del tweeter en un dels dos altaveus, detectada per una caiguda a la resposta al punt de tall i corregida manualment amb programari; sense aquesta detecció, l'altaveu hauria quedat amb un error de configuració permanent. Això posa de manifest una limitació estructural del disseny: el resultat final no és fix com en un producte comercial acabat, sinó tan bo com el coneixement tècnic de la persona que l'ajusta.

## Comparació de preu:

El cost total del prototip és d’aproximadament 413 € per parell, una quantitat considerablement inferior a la dels dos models comercials utilitzats com a referència. El Wharfedale Linton Heritage té un preu aproximat d’entre 1.100 i 1.500 € per parell, mentre que el Genelec 8341A se situa al voltant dels 4.500 € per parell. En comparació, el disseny propi representa aproximadament entre un 27 i un 38 % del cost del Linton, i menys d’un 10 % del cost del Genelec.
...
Cal tenir en compte, però, que aquest resultat depèn directament dels coneixements i de l’experiència de la persona que dissenya i ajusta el sistema. En un altaveu amb crossover digital, una configuració incorrecta dels nivells, les freqüències de tall o la fase pot deteriorar considerablement el resultat final. Per tant, el cost reduït del projecte no implica que es puguin obtenir les mateixes prestacions sense els coneixements tècnics necessaris per dissenyar, mesurar i ajustar correctament el sistema.
...
1.  [The Forgotten Johann Philipp Reis](https://web.archive.org/web/20150612190406/https:/www.integratednetworkcable.com/technology/the-forgotten-johann-philipp-reis%20-%20The%20Forgotten%20Johann%20Philipp%20Reis) [↑](#footnote-ref-1)
    
2.  [Loudspeaker History](https://www.aes-media.org/historical/html/recording.technology.history/loudspeaker.html) [↑](#footnote-ref-2)